...
manualCountryCodesForSearch: [
  ...
  industries: [
    ...
    'Finance', 'Food & Beverage', 'Healthcare', 'Hospitality', 'Insurance', 'Machinery',
    'Manufacturing', 'Media', 'Pharmaceuticals', 'Recreation', 'Retail',
    ...
    'Fishery', 'Food Production', 'Fund-Raising', 'Gambling & Casinos',
    'Graphic Design', 'Health, Wellness and Fitness', 'Higher Education', 'Human Resources',
    ...
    'Paper & Forest Products', 'Performing Arts', 'Philanthropy', 'Photography', 'Plastics',
    'Primary/Secondary Education', 'Printing', 'Professional Training & Coaching', 'Program Development',
    'Publishing', 'Railroad Manufacture',
    'Ranching', 'Real Estate', 'Religious Institutions', 'Research', 'Restaurants',
    ...
    'Leisure', 'Logistics', 'Machinery', 'Management Consulting',
    ...
    'Environmental Services', 'Human Resources', 'Investment Banking',
    'Marketing & Advertising', 'Media & Entertainment', 'Non-profit Organization Management',
    ...
    'Publishing & Editing', 'Research & Development', 'Retail Trade',
